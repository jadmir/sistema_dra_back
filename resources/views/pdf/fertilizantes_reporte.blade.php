...
<head>
    <meta charset="UTF-8">
    <title>Reporte Fertilizantes F-4 - SIEA</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'Arial', sans-serif; font-size: 8px; color: #333; line-height: 1.2; }
        .container { width: 100%; }
        ...
        .info-label { display: table-cell; width: 20%; font-weight: bold; color: #8B4513; padding: 2px; font-size: 8px; }
        .info-value { display: table-cell; width: 80%; padding: 2px; font-size: 8px; }
        ...
        th { background: #FFE082; border: 1px solid #333; padding: 4px 3px; text-align: center; font-weight: bold; }
        td { border: 1px solid #333; padding: 3px 2px; text-align: center; }
...
<body>
    <div class="container">
            ...
            <div class="header-content">
                ...
                <div class="header-center">
                    <div class="header-title">
                        ...
                        <h3>PRECIOS DE PRINCIPALES FERTILIZANTES Y ABONOS ORGÁNICOS (S/.)</h3>
                    </div>
                </div>
                <div class="header-right">
                    <div class="code-box">F-4</div>
                </div>
            </div>
        </div>
        ...
        <!-- TABLA DE DATOS -->
        <div class="section-title">III. INFORMACIÓN DE PRECIOS DE PRINCIPALES FERTILIZANTES Y ABONOS ORGÁNICOS</div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th colspan="3" style="width: 35%;">PRECIOS (S/.)</th>
            ...
            <tbody>
                    ...
                    @if($productos->isNotEmpty())
                        ...
                        <tr>
                            <td colspan="8" class="bg-categoria text-left">
                                {{ $key == 'ORGANICOS' ? '2. ' : '1. ' }}{{ $nombreCategoria }}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="text-left" style="font-size: 6px;">{{ $key }}</td>
                            <td class="text-left"><strong>{{ $producto['nombre'] }}</strong></td>
                            <td style="font-size: 6px;">Bolsa x 50 Kg</td>
                ...
                <tr>
                    ...
                    <td class="text-right bg-promedio" style="font-weight: bold; font-size: 9px;">
                        S/. {{ number_format($estadisticas['precio_promedio'], 2) }}
                    </td>
                    <td class="bg-total" style="font-weight: bold; font-size: 9px;">
        ...
        <div class="footer">
            <div style="font-size: 6px; color: #666; margin-bottom: 4px;">
                * Precios expresados en Soles (S/.) por bolsa de 50 Kg<br>
                ** Los precios promedio son calculados a partir de múltiples encuestas realizadas en el período indicado
            </div>
            <div class="footer-signature">
                SISTEMA DE INFORMACIÓN ESTADÍSTICA AGRARIA - SIEA | F2-EISA-DGESEP-DEIA
            </div>
        </div>
    </div>
</body>
