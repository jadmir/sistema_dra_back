...
<head>
    ...
    <title>Reporte de Maquinaria Agrícola - F-1</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="header">
        <h1>🚜 REPORTE DE MAQUINARIA AGRÍCOLA - FORMULARIO F-1</h1>
        <p>Sistema Integrado de Estadística Agraria - SIEA</p>
        <p>Análisis de Precios de Maquinaria y Equipos Agrícolas</p>
    </div>
    ...
    <h3 style="font-size: 12px; color: #6A1B9A; margin: 15px 0 10px 0;">DETALLE DE ANÁLISIS DE PRECIOS</h3>

    <table class="datos">
        <thead>
            <tr>
                <th width="7%">Fecha</th>
                <th width="18%">Tipo Maquinaria</th>
